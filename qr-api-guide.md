...
**Please note:** Before the merchant will receive any callbacks, they need to subscribe to the [`user.checked-in.v1` Webhook](https://developer.vippsmobilepay.com/docs/APIs/webhooks-api/events).
